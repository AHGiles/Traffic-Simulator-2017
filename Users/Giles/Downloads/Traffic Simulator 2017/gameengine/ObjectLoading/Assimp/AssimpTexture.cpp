...
/*---------------------------------------------*/
void AssimpTexture::CreateEmptyTexture(int a_iWidth, int a_iHeight, GLenum format)
{
...
/*---------------------------------------------*/
void AssimpTexture::CreateFromData(unsigned char* bData, int a_iWidth, int a_iHeight, int a_iBPP, GLenum format, bool bGenerateMipMaps)
{
...
bool AssimpTexture::LoadTexture2D(std::string a_sPath, bool bGenerateMipMaps)
{
...
void AssimpTexture::SetSamplerParameter(GLenum parameter, GLenum value)
{
...
void AssimpTexture::SetFiltering(int a_tfMagnification, int a_tfMinification)
{
...
void AssimpTexture::BindTexture(int iTextureUnit)
{
...
void AssimpTexture::DeleteTexture()
{
...
int AssimpTexture::GetMinificationFilter()
{
	return tfMinification;
}

int AssimpTexture::GetMagnificationFilter()
{
	return tfMagnification;
}

int AssimpTexture::GetWidth()
{
	return iWidth;
}

int AssimpTexture::GetHeight()
{
	return iHeight;
}

int AssimpTexture::GetBPP()
{
	return iBPP;
}

GLuint AssimpTexture::GetTextureID()
{
	return uiTexture;
}

std::string AssimpTexture::GetPath()
{
	return sPath;
}

bool AssimpTexture::ReloadTexture()
{
	FREE_IMAGE_FORMAT fif = FIF_UNKNOWN;
	FIBITMAP* dib(0);
...
AssimpTexture tTextures[NUMTEXTURES];
